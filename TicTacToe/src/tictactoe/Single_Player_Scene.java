...
public class Single_Player_Scene extends AnchorPane {
    ...
    public Single_Player_Scene(Stage stage) {
        ...
        getStylesheets().add("/tictactoe/Single_player.css");
        ...
        textField.getStylesheets().add("/tictactoe/Single_player.css");
        ...
        enter_name_anchor.getStylesheets().add("/tictactoe/Single_player.css");
        ...
        back_btn.getStylesheets().add("/tictactoe/Single_player.css");
        ...
        label_anchor.getStylesheets().add("/tictactoe/Single_player.css");
        ...
        start_btn.getStylesheets().add("/tictactoe/Single_player.css");
