...
public  class Multi_player_Scene extends AnchorPane {
    ...
    public Multi_player_Scene(Stage stage) {
        ...
        getStylesheets().add("/tictactoe/Multi%20player.css");
        ...
        title_anchor.getStylesheets().add("/tictactoe/Multi%20player.css");
        ...
        back_btn.getStylesheets().add("/tictactoe/Multi%20player.css");
        ...
        label1_anchor.getStylesheets().add("/tictactoe/Multi%20player.css");
        ...
        label1.getStylesheets().add("/tictactoe/Multi%20player.css");
        ...
        player1_textfield.getStylesheets().add("/tictactoe/Multi%20player.css");
        ...
        player2_textfield.getStylesheets().add("/tictactoe/Multi%20player.css");
        ...
        start_btn.getStylesheets().add("/tictactoe/Multi%20player.css");
